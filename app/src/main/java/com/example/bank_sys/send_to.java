...
public class send_to extends AppCompatActivity {
    ...
    ArrayList<model> modelList_sendtouser = new ArrayList<>();
    ...
    private void showData(String phonenumber) {
        ...
        Cursor cursor = new DBmange(this).readselectuserdata(phonenumber);
        ...
        adapter = new CustomeAdapterSendToUser(send_to.this, modelList_sendtouser);
        mRecyclerView.setAdapter(adapter);
    }

    public void selectuser(int position) {
        selectuser_phonenumber = modelList_sendtouser.get(position).getName();
        Cursor cursor = new DBmange(this).readparticulardata(selectuser_phonenumber);
        while(cursor.moveToNext()) {
            ...
            new DBmange(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new DBmange(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
            Toast.makeText(this, "Transaction Successful!", Toast.LENGTH_LONG).show();
            startActivity(new Intent(send_to.this, MainActivity.class));
            finish();
        }
    }
    ...
    private void calculateAmount() {
        ...
        new DBmange(this).updateAmount(phonenumber, remainingamount);
    }

    @Override
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(send_to.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DBmange(send_to.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(send_to.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(send_to.this,view_members.class));
                        finish();
                    }
